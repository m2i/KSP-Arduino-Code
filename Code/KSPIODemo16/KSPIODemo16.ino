...
// ShiftDisplay display(9,10,8,COMMON_CATHODE,5);
 ...
 LedControl lc1=LedControl(10,8,9,2);  // Data,Clock,Load,#ofdisplays
 LedControl lc2=LedControl(7,5,6,2);  // Data,Clock,Load,#ofdisplays
 LedControl lc3=LedControl(4,2,3,2);  // Data,Clock,Load,#ofdisplays
//-----------------------------------------------------------------------------------------------------
