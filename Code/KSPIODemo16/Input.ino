  ...
  if (KSPBoardReceiveData()) {
    ...
    switch (id) {
      ...
      case 1:
        ...
        displayFloat1(lc,  0, VData.Alt);
        displayFloat1(lc,  1, VData.Alt);
        displayFloat2(lc1, 0, VData.Alt);
        displayFloat2(lc1, 1, VData.Alt);
        displayFloat3(lc2, 0, VData.Alt);
        displayFloat3(lc2, 1, VData.Alt);
        displayFloat4(lc3, 0, VData.Alt);
        displayFloat4(lc3, 1, VData.Alt);
        // -----------------------------------------------------------------------------------------
